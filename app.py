...
PREDEFINED_QUERIES = [
    "Who is Custom Processing Services and what do they do? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "What services does Custom Processing Services offer? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "Is Custom Processing Services ISO/IEC 17025:2017 accredited for particle analysis and other tests? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "Does Custom Processing Services support pilot trials to full production? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "Which industries does Custom Processing Services serve? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "How does Custom Processing Services handle process safety and compliance for toll processing engagements? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "How do I request lab services or schedule a consultation with Custom Processing Services? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "What is toll manufacturing and when should a manufacturer use it vs building capacity in-house? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "Toll manufacturing vs. contract manufacturing — what’s the difference for chemical processing? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "How does custom chemical blending work for regulated materials? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "What are the advantages of toll processing for specialty chemicals and advanced materials? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "What safety standards apply to chemical processing and how do vendors demonstrate compliance? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "How do companies scale formulations from lab to pilot to production with one partner? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "What is formulation development and how does it pair with toll processing? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "How to choose a toll manufacturer? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "What is the cost of toll processing, and what drives pricing? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "What should be in a toll manufacturing agreement? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "Typical lead times and MOQs for GMP-grade blending & packaging? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "ISO-certified toll processor checklist — what should Procurement verify pre-award? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "Toll processing near me vs national partner? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "Best way to achieve tight particle size control for battery materials or advanced ceramics? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "Jet milling vs. mechanical milling -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "Wet media milling for coatings/inks — impact on gloss, opacity, and stability; test methods to confirm. -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "Cryogenic milling of heat-sensitive polymers — when to use, and what documentation will QA expect? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "Pharmaceutical blending: how to ensure content uniformity and GMP compliance -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "Emulsion polymerization support — what in-process data and COAs should a toller provide? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "Designing a pilot to production run: sample plan, batch records, and scale-up risk controls. -- Provide sources where you are extracting information from in this format - 'https?://\\S+'",
    "Which analytical tests confirm particle size & distribution for release? -- Provide sources where you are extracting information from in this format - 'https?://\\S+'"
]
